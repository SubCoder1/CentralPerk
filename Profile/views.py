...
def view_profile(request, username=None):
    ...
    if user != request.user:
        ...
        if user_acc_settings.private_acc:
            if isFollowing:
                user_posts = user.posts.values_list('post_id', 'status_caption', 'pic_thumbnail__url', 'likes_count', 'comment_count', named=True)
            else:
        ...
        user_posts = user.posts.values_list('post_id', 'status_caption', 'pic_thumbnail__url', 'likes_count', 'comment_count', named=True)
        saved_posts = user.saved_by.values_list('post_id', 'status_caption', 'pic_thumbnail__url', 'likes_count', 'comment_count', named=True)
